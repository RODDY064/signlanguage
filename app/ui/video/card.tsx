...
export default function Card() {
  return (
    <Link href="/video/1">
    <div className='w-full md:w-[16rem] lg:w-[20rem] xl:w-[22rem] h-[17rem] border-2 hover:border-sky-500/60 flex-none rounded-[25px] border-black/10 p-2 cursor-pointer'>
        ...
        <div className='w-full flex justify-between gap-2 pt-2 px-2'>
           <div className='w-[85%]'>
           <h2 className='w-full  truncate font-medium my-2'>My name is Godfred I come from Kumasi but live att</h2>
           </div>
